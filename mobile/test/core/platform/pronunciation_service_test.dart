...
void main() {
  ...
  test('maps unavailable local voice to an explicit unavailable result', () async {
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(channel, (call) async => 'unavailable');

    expect(await AndroidPronunciationService().speak('word'), PronunciationResult.unavailable);
  });
  ...
  test('sends text to the offline pronunciation channel', () async {
    ...
    expect(await AndroidPronunciationService().speak('word'), PronunciationResult.spoken);
